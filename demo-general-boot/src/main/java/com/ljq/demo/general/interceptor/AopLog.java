...
import com.ljq.demo.general.common.config.AopLogConfig;
...
public class AopLog {
     ...
     * controller 层切点
     */
    @Pointcut("execution(* com.ljq.demo.general.controller..*.*(..))")
    ...
    private static String getIpAddress(HttpServletRequest request) {
        ...
        if(StrUtil.isNotEmpty(xFor) && !UNKNOWN_FIELD.equalsIgnoreCase(xFor)){
        ...
        if (StrUtil.isBlank(xFor) || UNKNOWN_FIELD.equalsIgnoreCase(xFor)) {
